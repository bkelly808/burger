...
# Technologies Used:
This is a Node Express app using MySQL as the database and Handlebars to serve the html page. Everything is saved into mySQL database.